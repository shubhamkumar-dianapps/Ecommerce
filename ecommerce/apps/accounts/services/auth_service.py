...
class AuthService:
    ...
    def create_session(user, request):
        """
        Create a session for a user (with auto-cleanup of oldest session if limit reached).
        Returns (session, tokens) tuple.
        """
        ...
        # Extract IP and user agent using centralized utilities
